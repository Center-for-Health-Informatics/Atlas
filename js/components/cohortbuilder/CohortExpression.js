define(function (require, exports) {
  ...
  const PrimaryCriteria = require('./PrimaryCriteria')
  const InclusionRule = require('./InclusionRule')
  const EndStrategies = require('./EndStrategies')
  const CriteriaTypes = require('./CriteriaTypes')
  const Period = require('./InputTypes/Period')
