...
import view from './reportDrilldown.html?raw'
...
import 'components/charts/trellisline'
import 'components/charts/histogram'
import 'components/charts/frequencyHistogram'
...
class ReportDrilldown extends Report {
  ...
  parseDonutData (rawData) {
    if (!!rawData && rawData.length > 0) {
      const mappedData = ChartUtils.mapConceptData(rawData)
