define(function (require, exports) {
  ...
  async function saveAnalysis (definition) {
    const definitionCopy = JSON.parse(ko.toJSON(definition))

    if (typeof definitionCopy.expression !== 'string') { definitionCopy.expression = JSON.stringify(definitionCopy.expression) }
  ...
  function runDiagnostics (design) {
    const designCopy = JSON.parse(ko.toJSON(design))
