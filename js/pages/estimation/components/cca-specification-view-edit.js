...
import view from './cca-specification-view-edit.html?raw'
import AutoBind from 'utils/AutoBind'
import Component from 'components/Component'
import commonUtils from 'utils/CommonUtils'
import CohortMethodAnalysis from '../inputTypes/ComparativeCohortAnalysis/CohortMethodAnalysis'
import Comparison from '../inputTypes/Comparison'
import constants from '../const'
import './editors/comparison-editor'
import './editors/cohort-method-analysis-editor'
import './editors/negative-control-outcome-cohort-settings-editor'
import './editors/positive-control-sythesis-settings-editor'
import './cca-specification-view-edit.less'
...
class ComparativeCohortAnalysisSpecificationViewEdit extends AutoBind(Component) {
  ...
  addComparison () {
    ...
    // Get the index
    const index = this.comparisons().length - 1
