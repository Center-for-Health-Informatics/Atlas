...
function PayerPlanPeriodViewModel (params) {
  ...
  self.addActions = [
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.PayerConcept() == null) { self.Criteria.PayerConcept(ko.observable()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.PlanConcept() == null) { self.Criteria.PlanConcept(ko.observable()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.SponsorConcept() == null) { self.Criteria.SponsorConcept(ko.observable()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.StopReasonConcept() == null) { self.Criteria.StopReasonConcept(ko.observable()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.PayerSourceConcept() == null) { self.Criteria.PayerSourceConcept(ko.observable()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.PlanSourceConcept() == null) { self.Criteria.PlanSourceConcept(ko.observable()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.SponsorSourceConcept() == null) { self.Criteria.SponsorSourceConcept(ko.observable()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.StopReasonSourceConcept() == null) { self.Criteria.StopReasonSourceConcept(ko.observable()) }
      },
    },
    {
