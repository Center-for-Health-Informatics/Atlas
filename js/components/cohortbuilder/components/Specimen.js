  ...
  function SpecimenViewModel (params) {
    ...
    self.addActions = [
      ...
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.SpecimenType() == null) { self.Criteria.SpecimenType(ko.observableArray()) }
        },
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.SpecimenTypeCS() == null) { self.Criteria.SpecimenTypeCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
        },
      },
      {
      ...
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.AnatomicSite() == null) { self.Criteria.AnatomicSite(ko.observableArray()) }
        },
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.AnatomicSiteCS() == null) { self.Criteria.AnatomicSiteCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
        },
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.DiseaseStatus() == null) { self.Criteria.DiseaseStatus(ko.observableArray()) }
        },
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.DiseaseStatusCS() == null) { self.Criteria.DiseaseStatusCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
        },
      },
      {
