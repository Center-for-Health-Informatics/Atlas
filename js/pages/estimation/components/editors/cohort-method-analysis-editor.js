...
import view from './cohort-method-analysis-editor.html?raw'
...
class CohortMethodAnalysisEditor extends Component {
  constructor (params) {
    ...
    this.useRegularization = ko.observable(!!estimationConstants.isUsingRegularization(this.analysis.createPsArgs.prior))
