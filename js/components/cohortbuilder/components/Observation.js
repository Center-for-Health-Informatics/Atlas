...
function ObservationViewModel (params) {
  ...
  self.addActions = [
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.ObservationType() == null) { self.Criteria.ObservationType(ko.observableArray()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.ObservationTypeCS() == null) { self.Criteria.ObservationTypeCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
      },
    },
    {
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.Qualifier() == null) { self.Criteria.Qualifier(ko.observableArray()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.QualifierCS() == null) { self.Criteria.QualifierCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
      },
    },
    {
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.ObservationSourceConcept() == null) { self.Criteria.ObservationSourceConcept(ko.observable()) }
      },
    },
    {
