...
function DrugExposureViewModel (params) {
  ...
  self.addActions = [
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.DrugType() == null) { self.Criteria.DrugType(ko.observableArray()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.DrugTypeCS() == null) { self.Criteria.DrugTypeCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
      },
    },
    {
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.RouteConcept() == null) { self.Criteria.RouteConcept(ko.observableArray()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.RouteConceptCS() == null) { self.Criteria.RouteConceptCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
      },
    },
    {
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.DoseUnit() == null) { self.Criteria.DoseUnit(ko.observableArray()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.DoseUnitCS() == null) { self.Criteria.DoseUnitCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
      },
    },
    {
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.DrugSourceConcept() == null) { self.Criteria.DrugSourceConcept(ko.observable()) }
      },
    },
    {
