...
class CreatePsArgs extends RLangClass {
  constructor (data = {}) {
    ...
    this.control = data.control === undefined ? new Control({ cvType: 'auto', startingVariance: 0.01, tolerance: 0.0000002, cvRepetitions: 10, noiseLevel: 'silent', seed: 1 }) : new Control(data.control)
  }
}
