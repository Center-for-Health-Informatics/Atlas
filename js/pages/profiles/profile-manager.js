...
import 'extensions/bindings/profileChart'
import './profile-manager.less'
import 'components/heading'
import 'components/ac-access-denied'

const reduceToRecs = [ // crossfilter group reduce functions where group val
...
class ProfileManager extends AutoBind(Page) {
  constructor (params) {
    ...
    this.loadConceptSets = (o) => {
      ...
      const conceptSets = ko.toJS(o.cohortDef.expression().ConceptSets())
  ...
  loadPerson () {
    ...
    const url = constants.paths.person(this.sourceKey(), this.personId())
