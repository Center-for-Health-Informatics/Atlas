...
function CycleToggleInputViewModel (params) {
  ...
  self.nextOption = function () {
    const nextIndex = (self.currentIndex() + 1) % self.options.length
    self.value(self.options[nextIndex].value)
  }
}

// return compoonent definition
export { CycleToggleInputViewModel, template }
export default { viewModel: CycleToggleInputViewModel, template }
