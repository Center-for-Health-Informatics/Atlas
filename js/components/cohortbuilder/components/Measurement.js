...
function MeasurementViewModel (params) {
  ...
  self.addActions = [
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.MeasurementType() == null) { self.Criteria.MeasurementType(ko.observableArray()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.MeasurementTypeCS() == null) { self.Criteria.MeasurementTypeCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
      },
    },
    {
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.Operator() == null) { self.Criteria.Operator(ko.observableArray()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.OperatorCS() == null) { self.Criteria.OperatorCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.ValueAsNumber() == null) { self.Criteria.ValueAsNumber(new Range()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.ValueAsConcept() == null) { self.Criteria.ValueAsConcept(ko.observableArray()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.ValueAsConceptCS() == null) { self.Criteria.ValueAsConceptCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
      },
    },
    {
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.RangeLow() == null) { self.Criteria.RangeLow(new Range()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.RangeHigh() == null) { self.Criteria.RangeHigh(new Range()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.RangeLowRatio() == null) { self.Criteria.RangeLowRatio(new Range()) }
      },
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.RangeHighRatio() == null) { self.Criteria.RangeHighRatio(new Range()) }
      },
    },
    {
    ...
    },
    {
      ...
      selected: false,
      action: function () {
        if (self.Criteria.MeasurementSourceConcept() == null) { self.Criteria.MeasurementSourceConcept(ko.observable()) }
      },
    },
    {
