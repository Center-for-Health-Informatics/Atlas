  ...
  function VisitDetailViewModel (params) {
    ...
    self.addActions = [
      ...
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.VisitDetailTypeCS() == null) { self.Criteria.VisitDetailTypeCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
        },
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.VisitDetailLength() == null) { self.Criteria.VisitDetailLength(new Range()) }
        },
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.VisitDetailSourceConcept() == null) { self.Criteria.VisitDetailSourceConcept(ko.observable()) }
        },
      },
      {
