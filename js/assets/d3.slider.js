		...
		function slider(selection) {
			selection.each(function () {
				...
				function createAxis(dom) {
					...
					var axisOrientClass = "bottom";
					// Create axis if not defined by user
					if (typeof axis === "boolean") {
						var axisOrient = d3.axisBottom();
						if (orientation !== "horizontal") {
							axisOrient = d3.axisRight();
							axisOrientClass = "right";
						}
						axis = axisOrient.ticks(Math.round(sliderLength / 100))
					...
					var svg = dom.append("svg")
						.classed("d3-slider-axis d3-slider-axis-" + axisOrientClass, true)
						.on("click", stopPropagation);
