...
import view from './data-sources.html?raw'
import config from 'appConfig'
import authApi from 'services/AuthAPI'
import Page from 'pages/Page'
import commonUtils from 'utils/CommonUtils'
import 'databindings'
import './components/reports/person'
import './components/reports/dashboard'
import './components/reports/datadensity'
import './components/reports/person'
import './components/reports/visit'
import './components/reports/condition'
import './components/reports/conditionEra'
import './components/reports/procedure'
import './components/reports/drug'
import './components/reports/drugEra'
import './components/reports/measurement'
import './components/reports/observation'
...
class DataSources extends Page {
  ...
  onRouterParamsChanged (changedParams, newParams) {
    if (newParams == null && changedParams == null) { return }
