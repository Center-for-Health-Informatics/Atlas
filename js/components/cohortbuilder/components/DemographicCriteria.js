  ...
  function DemographicCriteriaViewModel (params) {
    ...
    self.addActions = [
      ...
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.Race() == null) { self.Criteria.Race(ko.observableArray()) }
        },
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.RaceCS() == null) { self.Criteria.RaceCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
        },
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.Ethnicity() == null) { self.Criteria.Ethnicity(ko.observableArray()) }
        },
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.EthnicityCS() == null) { self.Criteria.EthnicityCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
        },
      },
    ]
