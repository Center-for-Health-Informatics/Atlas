...
import EstimationAnalysis from './inputTypes/EstimationAnalysis'
import Comparison from './inputTypes/Comparison'
import ConceptSet from 'services/analysis/ConceptSet'
import TargetComparatorOutcomes from './inputTypes/TargetComparatorOutcomes'
...
import './components/cca-utilities'
import './cca-manager.less'
import 'databindings'
...
class ComparativeCohortAnalysisManager extends Page {
  ...
  async save () {
    ...
    const estimationName = this.estimationAnalysis().name()
  ...
  prepForSave () {
    ...
    const pcsaCovarSettings = specification.positiveControlSynthesisArgs.covariateSettings
