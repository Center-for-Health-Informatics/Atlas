define(function (require, exports) {
  const ConditionOccurrence = require('./CriteriaTypes/ConditionOccurrence')
  const ConditionEra = require('./CriteriaTypes/ConditionEra')
  const DrugExposure = require('./CriteriaTypes/DrugExposure')
  const DrugEra = require('./CriteriaTypes/DrugEra')
  const DoseEra = require('./CriteriaTypes/DoseEra')
  const Observation = require('./CriteriaTypes/Observation')
  const ProcedureOccurrence = require('./CriteriaTypes/ProcedureOccurrence')
  const Specimen = require('./CriteriaTypes/Specimen')
  const VisitOccurrence = require('./CriteriaTypes/VisitOccurrence')
  const VisitDetail = require('./CriteriaTypes/VisitDetail')
  const DeviceExposure = require('./CriteriaTypes/DeviceExposure')
  const Measurement = require('./CriteriaTypes/Measurement')
  const ObservationPeriod = require('./CriteriaTypes/ObservationPeriod')
  const Death = require('./CriteriaTypes/Death')
  const DemographicCriteria = require('./CriteriaTypes/DemographicCriteria')
  const PayerPlanPeriod = require('./CriteriaTypes/PayerPlanPeriod')
  const LocationRegion = require('./CriteriaTypes/LocationRegion')
