  ...
  function ProcedureOccurrenceViewModel (params) {
    ...
    self.addActions = [
      ...
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.ProcedureType() == null) { self.Criteria.ProcedureType(ko.observableArray()) }
        },
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.ProcedureTypeCS() == null) { self.Criteria.ProcedureTypeCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
        },
      },
      {
      ...
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.Modifier() == null) { self.Criteria.Modifier(ko.observableArray()) }
        },
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.ModifierCS() == null) { self.Criteria.ModifierCS(new ConceptSetSelection({}, self.expression.ConceptSets)) }
        },
      },
      {
      ...
      },
      {
        ...
        selected: false,
        action: function () {
          if (self.Criteria.ProcedureSourceConcept() == null) { self.Criteria.ProcedureSourceConcept(ko.observable()) }
        },
      },
      {
