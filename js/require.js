...
RegExp)
  ...
  } function u (b, c) { return function () { return c.apply(b, arguments) } } function ca (b) { throw b } function da (b) { if (!b) return b; let c = ba; v(b.split('.'), function (b) { c = c[b] }); return c } function C (b, c, d, e) { c = Error(c + '\nhttp://requirejs.org/docs/errors.html#' + b); c.requireType = b; c.requireModules = e; d && (c.originalError = d); return c } function ga (b) {
    function c (a, k, b) {
...
Q.test(a[l]) && (a[l] = a[l].replace(Q, '')); a[0].charAt(0) === '.' && k && (l = k.slice(0, k.length - 1), a = l.concat(a)); l = a; for (c = 0; c < l.length; c++) if (d = l[c], d === '.')l.splice(c, 1), c -= 1; else if (d === '..' && !(c === 0 || c === 1 && l[2] === '..' || l[c - 1] === '..') && c > 0)l.splice(c - 1, 2), c -= 2; a = a.join('/')
      ...
      k, b) { const f = a.id; let c = m(h, f); if (t(r, f) && (!c || c.defineEmitComplete))k === 'defined' && b(r[f]); else if (c = s(a), c.error && k === 'error')b(c.error); else c.on(k, b) } function w (a, b) { const c = a.requireModules; let f = !1; if (b)b(a); else if (v(c, function (b) { if (b = m(h, b))b.error = a, b.events.error && (f = !0, b.emit('error', a)) }), !f)g.onError(a) } function x () { R.length && (ha.apply(A, [A.length, 0].concat(R)), R = []) } function y (a) { delete h[a]; delete V[a] } function F (a, b, c) {
      const f = a.map.id; a.error
      ...
      let a; let b; const c = (a = 1E3 * j.waitSeconds) && i.startTime + a < (new Date()).getTime(); const f = []; const l = []; let g = !1; let h = !0; if (!W) {
        W = !0; B(V, function (a) { const i = a.map; const j = i.id; if (a.enabled && (i.isDefine || l.push(a), !a.error)) if (!a.inited && c)e(j) ? g = b = !0 : (f.push(j), d(j)); else if (!a.inited && (a.fetched && i.isDefine) && (g = !0, !i.prefix)) return h = !1 }); if (c && f.length) {
    ...
    } let W; let Z; let i; let L; let X; var j = { waitSeconds: 7, baseUrl: './', paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {} }; var h = {}; var V = {}; const $ = {}; var A = []; var r = {}; const S = {}; const aa = {}; var K = 1; var O = 1; L = {
      require: function (a) { return a.require ? a.require : a.require = i.makeRequire(a.map) },
      exports: function (a) { a.usingExports = !0; if (a.map.isDefine) return a.exports ? r[a.map.id] = a.exports : a.exports = r[a.map.id] = {} },
      module: function (a) {
        return a.module
          ? a.module
          : a.module = { id: a.map.id, uri: a.map.url, config: function () { return m(j.config, a.map.id) || {} }, exports: a.exports || (a.exports = {}) }
      }
...
c; this.inited = !0; this.ignore = f.ignore; f.enabled || this.enabled ? this.enable() : this.check()
      ...
      fetch: function () { if (!this.fetched) { this.fetched = !0; i.startTime = (new Date()).getTime(); const a = this.map; if (this.shim)i.makeRequire(this.map, { enableBuildCallback: !0 })(this.shim.deps || [], u(this, function () { return a.prefix ? this.callPlugin() : this.load() })); else return a.prefix ? this.callPlugin() : this.load() } },
      load: function () {
        const a =
            ...
            if (this.error) this.emit('error', this.error); else {
              if (!this.defining) {
                this.defining = !0; if (this.depCount < 1 && !this.defined) {
                  if (G(l)) {
                    if (this.events.error && this.map.isDefine || g.onError !== ca) try { f = i.execCb(c, l, b, f) } catch (d) { a = d } else f = i.execCb(c, l, b, f); this.map.isDefine && void 0 === f && ((b = this.module)
                      ? f = b.exports
                      : this.usingExports &&
...
this.map; const b = a.id; const d = p(a.prefix); this.depMaps.push(d); q(d, 'defined', u(this, function (f) {
          let l, d; d = m(aa, this.map.id); let e = this.map.name; const P = this.map.parentMap ? this.map.parentMap.name : null; const n = i.makeRequire(a.parentMap, { enableBuildCallback: !0 }); if (this.map.unnormalized) {
            ...
            d
              ...
              : (l = u(this, function (a) { this.init([], function () { return a }, null, { enabled: !0 }) }), l.error = u(this, function (a) { this.inited = !0; this.error = a; a.requireModules = [b]; B(h, function (a) { a.map.id.indexOf(b + '_unnormalized') === 0 && y(a.map.id) }); w(a) }), l.fromText = u(this, function (f, c) {
...
(this.defineDep(b, a), this.check())
      ...
      on: function (a, b) { let c = this.events[a]; c || (c = this.events[a] = []); c.push(b) },
      emit: function (a, b) { v(this.events[a], function (a) { a(b) }); a === 'error' && delete this.events[a] }
    }
    i = {
      config: j,
      contextName: b,
      ...
      configure: function (a) {
        a.baseUrl && a.baseUrl.charAt(a.baseUrl.length - 1) !== '/' && (a.baseUrl += '/'); const b = j.shim; const c = { paths: !0, bundles: !0, config: !0, map: !0 }; B(a, function (a, b) { c[b] ? (j[b] || (j[b] = {}), U(j[b], a, !0, !0)) : j[b] = a }); a.bundles && B(a.bundles, function (a, b) { v(a, function (a) { a !== b && (aa[a] = b) }) }); a.shim && (B(a.shim, function (a, c) {
          H(a) && (a = { deps: a }); if ((a.exports || a.init) && !a.exportsFn) {
            a.exportsFn =
i.makeShimExports(a)
          }b[c] = a
        }), j.shim = b); a.packages && v(a.packages, function (a) { let b; var a = typeof a === 'string' ? { name: a } : a; b = a.name; a.location && (j.paths[b] = a.location); j.pkgs[b] = a.name + '/' + (a.main || 'main').replace(ia, '').replace(Q, '') }); B(h, function (a, b) { !a.inited && !a.map.unnormalized && (a.map = p(b, null, !0)) }); if (a.deps || a.callback)i.require(a.deps || [], a.callback)
      },
      makeShimExports: function (a) { return function () { let b; a.init && (b = a.init.apply(ba, arguments)); return b || a.exports && da(a.exports) } },
      makeRequire: function (a,
        e) {
        function j (c, d, m) { let n, q; e.enableBuildCallback && (d && G(d)) && (d.__requireJsBuild = !0); if (typeof c === 'string') { if (G(d)) return w(C('requireargs', 'Invalid require call'), m); if (a && t(L, c)) return L[c](h[a.id]); if (g.get) return g.get(i, c, a, j); n = p(c, a, !1, !0); n = n.id; return !t(r, n) ? w(C('notloaded', 'Module name "' + n + '" has not been loaded yet for context: ' + b + (a ? '' : '. Use require([])'))) : r[n] }J(); i.nextTick(function () { J(); q = s(p(null, a)); q.skipMap = e.skipMap; q.init(c, d, m, { enabled: !0 }); D() }); return j }e = e || {}; U(j,
          { isBrowser: z, toUrl: function (b) { let d; const e = b.lastIndexOf('.'); const k = b.split('/')[0]; if (e !== -1 && (!(k === '.' || k === '..') || e > 1))d = b.substring(e, b.length), b = b.substring(0, e); return i.nameToUrl(c(b, a && a.id, !0), d, !0) }, defined: function (b) { return t(r, p(b, a, !1, !0).id) }, specified: function (b) { b = p(b, a, !1, !0).id; return t(r, b) || t(h, b) } }); a || (j.undef = function (b) {
          x(); const c = p(b, a, !0); const e = m(h, b); e.undefed = !0; d(b); delete r[b]; delete S[c.url]; delete $[b]; T(A, function (a, c) { a[0] === b && A.splice(c, 1) }); e && (e.events.defined && ($[b] = e.events),
          y(b))
        }); return j
      },
      enable: function (a) { m(h, a.id) && s(a).enable() },
      completeLoad: function (a) { let b; let c; const d = m(j.shim, a) || {}; const g = d.exports; for (x(); A.length;) { c = A.shift(); if (c[0] === null) { c[0] = a; if (b) break; b = !0 } else c[0] === a && (b = !0); E(c) }c = m(h, a); if (!b && !t(r, a) && c && !c.inited) { if (j.enforceDefine && (!g || !da(g))) return e(a) ? void 0 : w(C('nodefine', 'No define call for ' + a, null, [a])); E([a, d.deps || [], d.exportsFn]) }D() },
      nameToUrl: function (a, b, c) {
        let d, e, h; (d = m(j.pkgs, a)) && (a = d); if (d = m(aa, a)) return i.nameToUrl(d, b, c); if (g.jsExtRegExp.test(a)) {
          d =
a + (b || '')
        } else { d = j.paths; a = a.split('/'); for (e = a.length; e > 0; e -= 1) if (h = a.slice(0, e).join('/'), h = m(d, h)) { H(h) && (h = h[0]); a.splice(0, e, h); break }d = a.join('/'); d += b || (/^data\:|\?/.test(d) || c ? '' : '.js'); d = (d.charAt(0) === '/' || d.match(/^[\w\+\.\-]+:/) ? '' : j.baseUrl) + d } return j.urlArgs ? d + ((d.indexOf('?') === -1 ? '?' : '&') + j.urlArgs) : d
      },
      load: function (a, b) { g.load(i, a, b) },
      execCb: function (a, b, c, d) { return b.apply(d, c) },
      onScriptLoad: function (a) {
        if (a.type === 'load' || ja.test((a.currentTarget || a.srcElement).readyState)) {
          N = null,
          a = I(a), i.completeLoad(a.id)
        }
      },
      onScriptError: function (a) { const b = I(a); if (!e(b.id)) return w(C('scripterror', 'Script error for: ' + b.id, a, [b.id])) }
...
'undefined'; var ja = z && navigator.platform === 'PLAYSTATION 3' ? /^complete$/ : /^(complete|loaded)$/; var Y = typeof opera !== 'undefined' && opera.toString() === '[object Opera]'; const F = {}; let q = {}; var R = []; var M = !1; if (typeof define === 'undefined') {
    if (typeof requirejs !== 'undefined') { if (G(requirejs)) return; q = requirejs; requirejs = void 0 } typeof require !== 'undefined' && !G(require) && (q = require, require = void 0); g = requirejs = function (b, c, d, e) {
      let n; let p = '_'; !H(b) && typeof b !== 'string' && (n = b, H(c) ? (b = c, c = d, d = e) : b = []); n && n.context && (p = n.context);
      (e = m(F, p)) || (e = F[p] = g.s.newContext(p)); n && e.configure(n); return e.require(b, c, d)
    }; g.config = function (b) { return g(b) }; g.nextTick = typeof setTimeout !== 'undefined' ? function (b) { setTimeout(b, 4) } : function (b) { b() }; require || (require = g); g.version = '2.1.18'; g.jsExtRegExp = /^\/|:|\?|\.js$/; g.isBrowser = z; x = g.s = { contexts: F, newContext: ga }; g({}); v(['toUrl', 'undef', 'defined', 'specified'], function (b) { g[b] = function () { const c = F._; return c.require[b].apply(c, arguments) } }); if (z && (y = x.head = document.getElementsByTagName('head')[0],
    D = document.getElementsByTagName('base')[0]))y = x.head = D.parentNode; g.onError = ca; g.createNode = function (b) { const c = b.xhtml ? document.createElementNS('http://www.w3.org/1999/xhtml', 'html:script') : document.createElement('script'); c.type = b.scriptType || 'text/javascript'; c.charset = 'utf-8'; c.async = !0; return c }; g.load = function (b, c, d) {
      let e = b && b.config || {}; if (z) {
        return e = g.createNode(e, c, d), e.setAttribute('data-requirecontext', b.contextName), e.setAttribute('data-requiremodule', c), e.attachEvent && !(e.attachEvent.toString &&
e.attachEvent.toString().indexOf('[native code') < 0) && !Y
...
I, q.baseUrl || (E = s.split('/'), s = E.pop(), O = E.length ? E.join('/') + '/' : './', q.baseUrl = O), s = s.replace(Q, ''), g.jsExtRegExp.test(s) && (s = I), q.deps = q.deps ? q.deps.concat(s) : [s], !0
      ...
      let e, g; typeof b !== 'string' && (d = c, c = b, b = null); H(c) || (d = c, c = null); !c && G(d) && (c = [], d.length && (d.toString().replace(ka, '').replace(la, function (b, d) { c.push(d) }), c = (d.length === 1 ? ['require'] : ['require', 'exports', 'module']).concat(c))); if (M) {
        if (!(e = J)) {
          N && N.readyState === 'interactive' || T(document.getElementsByTagName('script'),
            function (b) { if (b.readyState === 'interactive') return N = b }), e = N
