...
options.negControlTableOptions = {
  ...
  },
  {
    ...
    binding: d => {
      const desc = d.descenantPmidCount
      const exact = d.exactPmidCount
      const parent = d.parentPmidCount
      if (exact > 0) {
  ...
  },
  {
    ...
    binding: d => {
      const desc = d.descenantSplicerCount
      const exact = d.exactSplicerCount
      const parent = d.parentSplicerCount
      if (exact > 0) {
        return ko.i18n('options.yesExact', 'Yes (Exact)')
      } else if (desc > 0) {
        return ko.i18n('options.yesDescendant', 'Yes (Descendant)')
  ...
  },
  {
    ...
    binding: d => {
      const desc = d.descenantFaersCount
      const exact = d.exactFaersCount
      const parent = d.parentFaersCount
      if (exact > 0) {
        return ko.i18n('options.yesExact', 'Yes (Exact)')
      } else if (desc > 0) {
        return ko.i18n('options.yesDescendant', 'Yes (Descendant)')
  ...
  },
  {
    ...
    binding: d => {
      const inc = d.userIncluded
      const exc = d.userExcluded
      if (inc > 0) {
